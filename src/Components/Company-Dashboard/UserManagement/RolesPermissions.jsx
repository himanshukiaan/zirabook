    ...
    <div className="p-4" style={{ background: "#f8f9fa", minHeight: "100vh" }}>
      ...
      >
        ...
        <Modal.Body>
          <Form.Group>
            ...
            <Form.Control
              ...
              isInvalid={!!newRoleType && customRoleTypes.includes(newRoleType)}
            />
            <Form.Control.Feedback type="invalid">
              This role type already exists.
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            disabled={!newRoleType || customRoleTypes.includes(newRoleType)}
            onClick={() => {
              if (newRoleType && !customRoleTypes.includes(newRoleType)) {
                setCustomRoleTypes([...customRoleTypes, newRoleType]);
                setForm({ ...form, type: newRoleType }); // auto-select
                setNewRoleType("");
                setShowAddTypeModal(false);
              }
            }}
