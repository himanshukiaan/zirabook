...
// ✅ Account Type to Account Names Mapping
...
const CreateVoucherModal = ({ show, onHide, onSave, editData }) => {
  ...
  // 🔹 Render Custom Form Based on Voucher Type
// 🔹 Render Custom Form Based on Voucher Type
                      ...
                      <tbody>
                        ...
                        {formData.isGST && (
                          <tr>
                            ...
                            <td className="text-end">₹{totals.gst.toFixed(2)}</td>
                          </tr>
                        )}
                        {formData.isTax && (
                          <tr>
